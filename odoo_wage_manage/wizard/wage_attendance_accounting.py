...
class WageAttendanceAccountingTransient(models.TransientModel):
    _name = 'wage.attendance.accounting.transient'
    _description = "考勤计算"
    ...
    @api.multi
    def compute_attendance_accounting(self):
        """
        计算考勤日报
        :return:
        """
        ...
        #     })
        #     # 获取员工考勤日报表
        #     domain = [('employee_id', '=', emp.id), ('work_month', '=', date_code)]
        #     attendance = self.env['hr.attendance.result'].search(domain, limit=1)
