        ...
        for u in user_list:
            ...
            while True:
                try:
                    ...
                    if leave_status:
                        ...
                        for leave in leave_status.get('leave_status_v_o'):
                            leave_data = {
                                ...
                                'end_time': self.env['attendance.api.tools'].get_time_stamp(leave['end_time']),
                                'start_time': self.env['attendance.api.tools'].get_time_stamp(leave['start_time']),
                            }
                    ...
                    raise UserError(e)
        action = self.env.ref('attendance_attendance.hr_leaves_list_action')
