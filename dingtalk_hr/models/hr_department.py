...
class HrDepartment(models.Model):
    ...
    _name = 'hr.department'
    _order = "is_root, parent_id, display_name, ding_order"
    ...
    is_root = fields.Boolean(string=u'是根部门', default=False)
    is_hiding = fields.Boolean(string=u'是否隐藏', default=False)
